...
await writeFile(
  ...
  `<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Simbiat · Prototype screenshots</title><style>*{box-sizing:border-box}body{font-family:Arial,sans-serif;color:#262626;background:#fafaf8;margin:0;padding:48px 5%}header{max-width:760px;margin-bottom:45px}h1{font-size:40px;letter-spacing:-1.5px;font-weight:500}p{font-size:14px;color:#666;line-height:1.8}h2{font-size:24px;font-weight:500;margin-top:45px}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:24px}a{display:block;border:1px solid #ddd;border-radius:8px;padding:15px;color:inherit;text-decoration:none;background:white}.preview{height:260px;overflow:hidden;border:1px solid #eee;background:#f3f3f0}.preview img{width:100%;display:block}h3{font-size:14px;font-weight:500;text-transform:capitalize}span{font-size:11px;color:#666}</style><header><span>PROJECT SCOPE PROTOTYPE</span><h1>Simbiat. A visual conversation.</h1><p>Desktop and mobile screenshots of every proposed screen. Click a preview to open the full PNG. Products, photography, prices, and content are illustrative; this is not the final website.</p></header>${sections}</html>`,
);
